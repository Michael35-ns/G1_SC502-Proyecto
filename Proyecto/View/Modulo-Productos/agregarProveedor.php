            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="heading text-danger  text-center font-weight-bold">Agregar Proveedores</h2>
                                <br />
                                <form class="forms-sample" action="" method="post">
                                    <div class="form-group">
                                        <label class="text-dark font-weight-bold">Descripción</label>
                                        <input type="text" class="form-control" name="txtDescripcion" placeholder="Ingrese la descripción del proveedor">
                                    </div>
                                    <button name="btnAgregarProveedor" type="submit" class="btn btn-inverse-primary me-2">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
