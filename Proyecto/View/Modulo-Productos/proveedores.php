  ...
  <!--LLamado al layout-->
		...
		?>
            <div class="card navbar-blur2">
                <div class="card-body">
                    <h2 class="card-title">Consulta de Proveedores</h2>
                
                    <div class="row">
                        <table id="tablaProveedores" class="table table-hover" style="margin: 20px;">
                            <thead>
                                <tr>
                                    <th>Identidad</th>
                                    <th>Descripción</th>
                ...
                <form action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-lg" id="txtIdNuevaDescripcion" 
                            name="txtIdNuevaDescripcion" value="">
                        </div>
                        ¿Desea cambiar el nombre del proveedor <label id="lblDescripcion" style="font-weight: bold;"></label>?
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-inverse-info btn-md font-weight-medium btn-rounded" id="btnCambiarDescripcionProveedor"
                            name="btnCambiarDescripcionProveedor">Procesar</button>
    ...
    <script>
        $(document).on("click", ".AbrirModal", function() {
            $("#lblDescripcion").text($(this).attr('data-name'));
            $("#txtIdProveedor").val($(this).attr('data-id'));
        });
