CREATE DATABASE ARENAL_FRAMES_BD;
...
ALTER TABLE `Orden` ADD FOREIGN KEY (`id_usuario`) REFERENCES `Usuarios` (`id_usuario`);
ALTER TABLE `Delivery` ADD FOREIGN KEY (`id_estado`) REFERENCES `Estado` (`id_estado`);
...
INSERT INTO `arenal_frames_bd`.`rol`
(`id_rol`,
`nombre_rol`)
VALUES
(3,"Proveedor");
